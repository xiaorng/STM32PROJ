...
<#assign CHARGE_BOOT_CAP_ENABLING = (! MC.M1_OTF_STARTUP) || ((MC.M1_OTF_STARTUP) && ((MC.M1_PWM_DRIVER_PN == "STDRIVE101") || (MC.M1_PWM_DRIVER_PN == "STSPIN32G4")) && (MC.M1_DP_TOPOLOGY != "NONE"))>
<#assign CHARGE_BOOT_CAP_ENABLING2 = (! MC.M2_OTF_STARTUP) || ((MC.M2_OTF_STARTUP) && ((MC.M2_PWM_DRIVER_PN == "STDRIVE101") || (MC.M1_PWM_DRIVER_PN == "STSPIN32G4")) && (MC.M2_DP_TOPOLOGY != "NONE"))>
